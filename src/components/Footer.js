      ...
      <div className="container-fluid">
        ...
        <div className="row justify-content-center pt-4 sm-pt-35px text-center text-md-start">
          <div className="col-xl-3 col-md-12 lg-mb-30px d-flex justify-content-center justify-content-xl-start">
            <Link href="/" className="footer-logo d-inline-block" aria-label="logo">
              <img src="/images/footer-logo.svg" alt="Adlyngo Logo" style={{ height: '100px', maxHeight: 'none', display: 'block' }} className="transition-03" />
            </Link>
          </div>
          ...
          <div className="col-xl-3 col-md-6 last-paragraph-no-margin lg-mb-30px">
            ...
            <div className="position-relative w-100">
              ...
              />
              <button className="btn p-0 text-white position-absolute top-0 right-0 h-100" type="submit" aria-label="submit">
          ...
          <div className="col-xl-1 col-md-2 text-md-end text-center pt-2">
            <a className="scroll-top text-base-color fs-13 text-uppercase fw-600 ls-1px" aria-label="scroll" href="#">
