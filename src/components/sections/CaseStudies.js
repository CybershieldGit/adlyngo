export default function CaseStudies() {
  ...
  return (
    <section className="py-0 ps-6 pe-6 xl-ps-3 xl-pe-3 md-ps-0 md-pe-0 position-relative overflow-hidden">
      <div className="bg-base-color h-100 position-absolute top-0 start-0 z-index-minus-1 lg-w-100" data-bottom-top="width:10%" data-center-top="width:100%;"></div>
        ...
        <div className="row justify-content-end g-0 flex-row-reverse">
          <div className="col-xl-5 col-lg-6 pt-7 pb-7 md-pb-5 sm-pt-50px sm-pb-50px tab-style-09 d-flex justify-content-between flex-column border-start md-border-start-0 border-color-transparent-white-very-light">
            <div className="ps-12 md-ps-4 sm-ps-0 pb-10 md-pb-5 position-relative z-index-9 text-center text-md-start">
              <span className="fs-24 lh-30 text-white">Crafting unique<br /><span className="highlight-separator pb-0" data-shadow-animation="true" data-animation-delay="1500">digital success.<span><img src="/images/highlight-separator-05-white.svg" alt="" /></span></span></span>
                  ...
                  <figure className="m-0 position-relative hover-box border-radius-15px overflow-hidden parallax-hover">
                    ...
                    <figcaption className="w-100 h-100 d-flex flex-column align-items-center p-40px">
                      <div className="position-relative d-flex flex-column h-100 z-index-1">
                        <a href="/project-details" className="d-flex justify-content-center align-items-center mx-auto mt-auto icon-box w-90px h-90px rounded-circle bg-white box-shadow-quadruple-large"><i className="bi bi-arrow-right-short text-dark-gray icon-medium lh-0px"></i></a>
                        <a href="/project-details" className="text-white d-block mt-auto">Discover case study</a>
                      </div>
